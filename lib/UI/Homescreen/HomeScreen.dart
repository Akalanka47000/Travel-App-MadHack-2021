...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  getSearchResults(String pattern, dynamic countryList) {
    ...
    for (dynamic country in countryList) {
      if (country["Country"].toUpperCase() == pattern.toUpperCase() ||
          (pattern.length >= 3 &&
              country["Country"]
                  .toUpperCase()
                  .toString()
                    ...
                    child: AppBar(
                      ...
                      title: Stack(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Constants.loggedInStatus?InkWell(
                                onTap: () async {
                                  return showDialog(
                                      context: context,
                                ...
                                child: Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(15, 5, 0, 6),
                                  child: Container(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: RotationTransition(
                                    turns: Tween(begin: 0.0, end: 1.0).animate(
                                        _settingsButtonRotationController),
                                    child: Icon(
                                      Icons.settings,
                                      size: 28,
                                      color: Constants.theme == "Dark"
                            ...
                            child: CarouselSlider.builder(
                              ...
                              itemBuilder:
                                ...
                                return GestureDetector(
                                  onTap: () async {
                                    if (menuOptions[itemIndex] == "Learn") {
                                      //Navigator.of(context).pop();
                                      //Navigator.push(context, new MaterialPageRoute(builder: (context) => Gallery()));
                                    } else if (menuOptions[itemIndex] ==
                                        "Profile") {
                                    } else if (menuOptions[itemIndex] ==
                                        "Teach") {
                                    } else if (menuOptions[itemIndex] ==
                                        ...
                                        child: Column(
                                          children: [
                                            Expanded(
                                              child: Image(
                                                image: AssetImage(
                                                    "assets/images/${menuOptions[itemIndex]}.png"),
                                              ),
                                            ),
                                            Padding(
                                              padding:
